module CoProcessor(
    ...
    /* Borda de subida: so conclui quando inference_done vai 0->1 nesta inferencia.
     * Evita falso DONE se inference_done ja estava em 1 ao entrar em ST_INFERENCE. */
        ...
        if (rst) begin
            ...
            case(state)
                ...
                ST_INFERENCE: begin //aguarda a inferencia acontecer
                    if (inference_done && !inference_done_prev) begin
