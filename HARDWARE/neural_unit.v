...
module neural_unit(
	...
	*************************************************************/
	...
	/* done registrado: 1 so no estado DONE; 0 em todos os outros.
	 * Substitui saida combinacional com latch (causa raiz do inference_done preso). */
	always @(posedge clk or posedge rst) begin
		if (rst)
			done <= 1'b0;
		else
